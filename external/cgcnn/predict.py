...
def main():
    ...
    test_loader = DataLoader(dataset, batch_size=args.batch_size, shuffle=False, #Changed from True
                             num_workers=0 if args.deterministic else args.workers, collate_fn=collate_fn, 
